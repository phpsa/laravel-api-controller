...
class TaskPolicy
{
     ...
     * @return mixed
     */
    public function view(?User $authed, Task $task)
    {
        return true;
    }
     ...
     * @return mixed
     */
    public function update(?User $authed, Task $task)
    {
        return true;
    }
     ...
     * @return mixed
     */
    public function delete(?User $authed, Task $task)
    {
        return true;
    }
     ...
     * @return mixed
     */
    public function restore(?User $authed, Task $task)
    {
        return true;
    }
     ...
     * @return mixed
     */
    public function forceDelete(?User $authed, Task $task)
    {
        return true;
    }
